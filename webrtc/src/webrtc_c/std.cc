...
WEBRTC_EXPORT void std_map_string_string_set(struct std_map_string_string* self,
                                             const char* key,
                                             size_t key_len,
                                             const char* value,
                                             size_t value_len) {

...
webrtc_GofInfoVP9_get_num_frames_in_gof(const struct webrtc_GofInfoVP9* self);
...
webrtc_GofInfoVP9_get_temporal_idx(const struct webrtc_GofInfoVP9* self,
                                   size_t index);
...
WEBRTC_EXPORT void webrtc_GofInfoVP9_set_temporal_up_switch(
    ...
    int value);
WEBRTC_EXPORT uint8_t
webrtc_GofInfoVP9_get_num_ref_pics(const struct webrtc_GofInfoVP9* self,
                                   size_t index);
WEBRTC_EXPORT void webrtc_GofInfoVP9_set_num_ref_pics(
    ...
    uint8_t value);
WEBRTC_EXPORT uint8_t
webrtc_GofInfoVP9_get_pid_diff(const struct webrtc_GofInfoVP9* self,
                               size_t index,
                               size_t ref_index);
...
webrtc_GofInfoVP9_get_pid_start(const struct webrtc_GofInfoVP9* self);
...
WEBRTC_EXPORT void webrtc_RTPVideoHeaderVP9_set_non_ref_for_inter_layer_pred(
    struct webrtc_RTPVideoHeaderVP9* self,
    int value);
WEBRTC_EXPORT int16_t webrtc_RTPVideoHeaderVP9_get_picture_id(
    const struct webrtc_RTPVideoHeaderVP9* self);
...
WEBRTC_EXPORT void webrtc_RTPVideoHeaderVP9_set_inter_layer_predicted(
    struct webrtc_RTPVideoHeaderVP9* self,
    int value);
WEBRTC_EXPORT uint8_t webrtc_RTPVideoHeaderVP9_get_gof_idx(
    const struct webrtc_RTPVideoHeaderVP9* self);
...
WEBRTC_EXPORT void webrtc_RTPVideoHeaderVP9_set_num_ref_pics(
    ...
    uint8_t value);
// 各配列は index を指定してアクセスする。
WEBRTC_EXPORT uint8_t webrtc_RTPVideoHeaderVP9_get_pid_diff(
    const struct webrtc_RTPVideoHeaderVP9* self,
    size_t index);
...
webrtc_RTPVideoHeaderVP9_set_spatial_layer_resolution_present(
    ...
    int value);
WEBRTC_EXPORT uint16_t
webrtc_RTPVideoHeaderVP9_get_width(const struct webrtc_RTPVideoHeaderVP9* self,
                                   size_t index);
WEBRTC_EXPORT void webrtc_RTPVideoHeaderVP9_set_width(
    ...
    uint16_t value);
WEBRTC_EXPORT uint16_t
webrtc_RTPVideoHeaderVP9_get_height(const struct webrtc_RTPVideoHeaderVP9* self,
                                    size_t index);

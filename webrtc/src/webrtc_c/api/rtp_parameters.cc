...
struct webrtc_RtpCodecCapability* WEBRTC_EXPORT
...
void WEBRTC_EXPORT
webrtc_RtpEncodingParameters_delete(struct webrtc_RtpEncodingParameters* self) {
  auto params = reinterpret_cast<webrtc::RtpEncodingParameters*>(self);
  delete params;
}
void WEBRTC_EXPORT
webrtc_RtpEncodingParameters_set_rid(struct webrtc_RtpEncodingParameters* self,
                                     const char* rid,
                                     size_t rid_len) {
  auto params = reinterpret_cast<webrtc::RtpEncodingParameters*>(self);
  params->rid = rid != nullptr ? std::string(rid, rid_len) : std::string();
}
struct std_string* WEBRTC_EXPORT webrtc_RtpEncodingParameters_get_rid(

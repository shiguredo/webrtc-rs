...
impl AudioOptions {
    ...
    pub fn echo_cancellation(&self) -> Option<bool> {
        ...
        let mut value = 0;
        unsafe {
            ffi::webrtc_AudioOptions_get_echo_cancellation(self.raw.as_ptr(), &mut has, &mut value);
        }
    ...
    pub fn set_echo_cancellation(&mut self, value: Option<bool>) {
        match value {
            Some(v) => {
                ...
                unsafe {
                    ffi::webrtc_AudioOptions_set_echo_cancellation(self.raw.as_ptr(), 1, &raw);
                }
            }
            None => unsafe {
                ffi::webrtc_AudioOptions_set_echo_cancellation(
                    self.raw.as_ptr(),
                    0,
                    std::ptr::null(),
                );
    ...
    pub fn auto_gain_control(&self) -> Option<bool> {
        ...
        let mut value = 0;
        unsafe {
            ffi::webrtc_AudioOptions_get_auto_gain_control(self.raw.as_ptr(), &mut has, &mut value);
        }
        if has == 0 { None } else { Some(value != 0) }
    }
    ...
    pub fn set_auto_gain_control(&mut self, value: Option<bool>) {
        match value {
            Some(v) => {
                let raw = if v { 1 } else { 0 };
                unsafe {
                    ffi::webrtc_AudioOptions_set_auto_gain_control(self.raw.as_ptr(), 1, &raw);
                }
            }
            None => unsafe {
                ffi::webrtc_AudioOptions_set_auto_gain_control(
                    self.raw.as_ptr(),
                    0,
                    std::ptr::null(),
                );
    ...
    pub fn noise_suppression(&self) -> Option<bool> {
        ...
        let mut value = 0;
        unsafe {
            ffi::webrtc_AudioOptions_get_noise_suppression(self.raw.as_ptr(), &mut has, &mut value);
        }
        if has == 0 { None } else { Some(value != 0) }
    }
    ...
    pub fn set_noise_suppression(&mut self, value: Option<bool>) {
        match value {
            Some(v) => {
                let raw = if v { 1 } else { 0 };
                unsafe {
                    ffi::webrtc_AudioOptions_set_noise_suppression(self.raw.as_ptr(), 1, &raw);
                }
            }
            None => unsafe {
                ffi::webrtc_AudioOptions_set_noise_suppression(
                    self.raw.as_ptr(),
                    0,
                    std::ptr::null(),
                );
    ...
    pub fn highpass_filter(&self) -> Option<bool> {
        ...
        let mut value = 0;
        unsafe {
            ffi::webrtc_AudioOptions_get_highpass_filter(self.raw.as_ptr(), &mut has, &mut value);
        }
        if has == 0 { None } else { Some(value != 0) }
    }
    ...
    pub fn set_highpass_filter(&mut self, value: Option<bool>) {
        match value {
            Some(v) => {
                let raw = if v { 1 } else { 0 };
                unsafe {
                    ffi::webrtc_AudioOptions_set_highpass_filter(self.raw.as_ptr(), 1, &raw);
                }
            }
            None => unsafe {
                ffi::webrtc_AudioOptions_set_highpass_filter(
                    self.raw.as_ptr(),
                    0,
                    std::ptr::null(),
                );
    ...
    pub fn stereo_swapping(&self) -> Option<bool> {
        ...
        let mut value = 0;
        unsafe {
            ffi::webrtc_AudioOptions_get_stereo_swapping(self.raw.as_ptr(), &mut has, &mut value);
        }
        if has == 0 { None } else { Some(value != 0) }
    }
    ...
    pub fn set_stereo_swapping(&mut self, value: Option<bool>) {
        match value {
            Some(v) => {
                let raw = if v { 1 } else { 0 };
                unsafe {
                    ffi::webrtc_AudioOptions_set_stereo_swapping(self.raw.as_ptr(), 1, &raw);
                }
            }
            None => unsafe {
                ffi::webrtc_AudioOptions_set_stereo_swapping(
                    self.raw.as_ptr(),
                    0,
                    std::ptr::null(),
                );
